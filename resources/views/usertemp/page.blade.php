...
<html>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-3 col-xs-2">
					<div id="fh5co-logo"><a href="index.html">Handphone Shop.</a></div>
				</div>
		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
					...
					<h2>Products.</h2>
					<p>Anda bisa lihat produk - produk handphone kami.</p>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-md-4 text-center animate-box">
					<div class="product">
						<div class="product-grid" style="background-image:url({{ asset('/img/'.$data->gambar.'') }});">
							<div class="inner">
								<p>
						...
						<div class="desc">
							<h3><a href="single.html">{{$data->nama_barang}}</a></h3>
						</div>
					</div>
				</div>
				@endforeach
	...
	<!-- countTo -->
	<script src="{{ url('user/js/jquery.countTo.js') }}"></script>
	<!-- Flexslider -->
